...
(function (BlockGame) {
    ...
    let blockCountX = 10;
    let blockCountY = 30;
    let gameWidth = blockCountX * blockSizeX;
    let gameHeight = blockCountY * blockSizeY;
    let lastRender = 0;
    let keyboardInterval = 100;
    let gameSpeedInterval = 500;
    let gameSpeedTimer;
    let keyboardTimer;
    let blockArrays;
    let gameArea;
    ...
    function initializeBlocks() {
        ...
        blockArrays[1] = BlockGame.BlockFactory.createLeftLBlock();
        blockArrays[2] = BlockGame.BlockFactory.createLongBlock();
        blockArrays[3] = BlockGame.BlockFactory.createRightLBlock();
        blockArrays[4] = BlockGame.BlockFactory.createTBlock();
    ...
    function initialize() {
        ...
        initializeBlocks();
        initializeGameArea();
        gameSpeedTimer = new BlockGame.UpdateTimer(gameSpeedInterval);
        keyboardTimer = new BlockGame.UpdateTimer(keyboardInterval);
        initializeScore();
...
//# sourceMappingURL=BlockGameMain.js.map